...
def main(args=None):
    ...
    #Create robots
    robots_followers = []
    robot_leader = Robot.FourWheelRobot(start, r'assets/vehicles/robot.png', 50)
    robot_leader.leader = True

    robot_follower1 = Robot.FourWheelRobot((start[0] - 200, start[1]), r'assets/vehicles/robot.png', 50, robot_leader)
    robots_followers.append(robot_follower1)

    robot_follower2 = Robot.FourWheelRobot((start[0] - 400, start[1]), r'assets/vehicles/robot.png', 50, robot_follower1)
